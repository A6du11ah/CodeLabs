...
import { MonacoBinding } from 'https://cdn.jsdelivr.net/npm/y-monaco@0.1.4/+esm';
...
function deployRoomConnectivity() {
    ...
    const signalingServerList = ["ws://localhost:4444"];
